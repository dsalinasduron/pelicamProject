...
\section{{\Large \itshape Entry 22, 7/10/19}
...
\section{{\Large \itshape Entry 23, 7/11/19}
    I have learned git workflows,
\newline
And tested my further trained model.
\newline
Turns out the model to accuracy became less close,
\newline
And merging sometimes can be hell.

\section{{\Large \itshape Entry 24, 7/13/19}
    I have labelled all the photos Emily gave me.
\newline
Generated all the tfrecords that could be.
\newline
Next stop: training!

\section{{\Large \itshape Entry 25, 7/15/19}
    Trained the model, took five hours,
\newline
Hope I don't have to train this anymore.
\newline
All that's left is to test its powers,
\newline
In a jupyter notebook steeped with tensor lore.

\section{{\Large \itshape Entry 26, 7/18/19}
    Listened to a podcast, tested the model.
\newline
It won't overcount pelicans.
\newline
Only problem is it can oversize the box a lottle.

\section{{\Large \itshape Entry 27, 7/21/19}
    Wrote code to run inference in folders,
\newline
But this time on pelicams.
\newline
I've now run into some new boulders,
\newline
For the model thinks everything's a pelican.

\section{{\Large \itshape Entry 28, 7/22/19 - 7/27/2019}
    Tweaked the models I have done,
\newline
Problems that I found are one.
\newline
I'm so close to achieving what I set out to do,
\newline
Only problem is my motivation is waning as we wrap up and reach our last meeting Tuesday too.
\newline
Worry not, it will be done.
\newline
Soon CSV over which Ali and I will have won.
\newline
Once that's finished, then you'll see,
\newline
A pelican identifier that works handily.
